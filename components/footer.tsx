...
const socialLinks = [
  { icon: GithubIcon, label: "GitHub", href: "https://github.com/datvikai" },
  { icon: XIcon, label: "X", href: "https://x.com/datvikai" },
  { icon: LinkedInIcon, label: "LinkedIn", href: "https://linkedin.com/company/datvikai" },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="py-14 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm text-slate-500 leading-relaxed mb-5 max-w-xs">
              The Agent OS. Build AI agents that integrate with your entire business.
              Write TypeScript tools, deploy instantly.
            </p>
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 mt-5 px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-sm text-slate-400 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all"
            >
              <Mail size={14} />
              Contact us
            </Link>
        ...
        <div className="py-6 border-t border-white/[0.06] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-600">
            © {new Date().getFullYear()} DatvikAI. All rights reserved.
          </p>
          <div className="flex items-center gap-4 text-xs text-slate-600">
            <Link href="/privacy" className="hover:text-slate-400 transition-colors">Privacy</Link>
            <Link href="/terms" className="hover:text-slate-400 transition-colors">Terms</Link>
            <a href="mailto:hello@datvikai.com" className="hover:text-slate-400 transition-colors">
              hello@datvikai.com
            </a>
          </div>
        </div>
