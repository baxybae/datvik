...
import { Mail, Lock, Eye, EyeOff, ArrowRight, User, Zap, Check } from "lucide-react";
import Link from "next/link";
import { Logo } from "@/components/logo";

const benefits = [
  "1 free agent included",
...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center relative overflow-hidden px-4 py-12">
      ...
      <div className="absolute bottom-1/4 left-1/4 w-[300px] h-[300px] bg-purple-600/[0.08] rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute top-1/2 right-1/3 w-[200px] h-[200px] bg-cyan-600/[0.05] rounded-full blur-[80px] pointer-events-none" />
      ...
      >
        ...
        <div className="glass-card rounded-2xl p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-slate-400">Start building AI agents in minutes</p>
          </div>
          ...
          <p className="text-[11px] text-slate-600 mt-4 text-center leading-relaxed">
            ...
            <Link href="/terms" className="text-slate-400 hover:text-slate-300 underline">Terms of Service</Link>{" "}
            and{" "}
            <Link href="/privacy" className="text-slate-400 hover:text-slate-300 underline">Privacy Policy</Link>.
          </p>
        </div>
